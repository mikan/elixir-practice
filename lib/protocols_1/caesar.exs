...
defimpl Caesar, for: List do
  def encrypt(string, shift), do: ListsAndRecursion3.caesar(string, shift)
  def rot13(string), do: encrypt(string, 13)
end

defimpl Caesar, for: BitString do
  def encrypt(string, shift), do: to_string(ListsAndRecursion3.caesar(to_charlist(string), shift))
  def rot13(string), do: encrypt(string, 13)
end
