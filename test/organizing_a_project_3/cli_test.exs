defmodule Cli3Test do
  use ExUnit.Case
  doctest ElixirPractice.OrganizingAProject3.CLI

  import ElixirPractice.OrganizingAProject3.CLI, only: [ parse_args: 1,
    sort_into_ascending_order: 1, convert_to_list_of_maps: 1]
